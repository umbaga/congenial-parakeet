...
class DndManageBreathWeapons extends React.Component {
    ...
    render() {
        ...
        const areaOfEffectShapes = util.common.picklists.getPicklistItems(this.props.picklists, util.itemtypes.TYPES.AREA_OF_EFFECT_SHAPE);
        ...
        const savingThrowEffects = util.common.picklists.getPicklistItems(this.props.picklists, util.itemtypes.TYPES.SAVE_EFFECT);
        return (
            <div>
                <DndInput
                    name="damage"
