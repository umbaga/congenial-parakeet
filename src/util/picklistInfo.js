...
export const ARMOR_PROFICIENCY_CATEGORY = 235;
export const LANGUAGE_PROFICIENCY_CATEGORY = 239;
export const SAVING_THROW_PROFICIENCY_CATEGORY = 240;
export const SKILL_PROFICIENCY_CATEGORY = 237;
export const TOOL_PROFICIENCY_CATEGORY = 238;
export const WEAPON_PROFICIENCY_CATEGORY = 236;

export const ASSIGNMENT_PROFICIENCY_MECHANIC = 554;
export const SELECT_FROM_CATEGORY_PROFICIENCY_MECHANIC = 555;
export const SELECT_FROM_LIST_PROFICIENCY_MECHANIC = 556;
