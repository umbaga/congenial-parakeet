...
sql += '     INNER JOIN adm_link_background_chart dc ON (dc."backgroundId" = d.id)';
sql += '     INNER JOIN (';
sql += '         SELECT  ';
sql += '             c.id,       ';
sql += '             c.title,';
...
sql += '         INNER JOIN adm_link_background_chart bgcht ON bgcht."chartId" = c.id';
...
sql += '  LEFT OUTER JOIN adm_link_background_equipment bglnkeq ON bglnkeq."backgroundId" = i.id';
